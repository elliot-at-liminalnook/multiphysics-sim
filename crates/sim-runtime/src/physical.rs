...
pub struct BuildOptions {
    ...
    pub flex: bool,
    pub contact: bool,
    /// Explicit approximation: omit all link-to-link contact forces; retain floor/terrain.
    /// Geometry audits must query inter-link overlap independently of force output.
