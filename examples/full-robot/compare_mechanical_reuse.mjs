...
fs.writeFileSync(output,JSON.stringify({version:1,timestep_reference:timestepReference,numerical_precision:numericalPrecision,block_factorization:blockFactorization,guarded_backtracking:guardedBacktracking,broyden_updates:broydenUpdates,linearized_probes:linearizedProbes,velocity_seed:velocitySeed,...(exactProbeBase?{exact_probe_base:true}:{}),baseline:{path:baselinePath,sha256:hash(baselinePath)},candidate:{path:candidatePath,sha256:hash(candidatePath)},markers:{path:markerPath,sha256:hash(markerPath)},frames:a.frames.length,metrics,contact_pair_mismatches,phase_mismatches,
