...
const root = 'examples/full-robot/whole-swing', run = 'runs/full-robot/learning/gentler-contact';
...
const profiles = plan.cases.map((c, i) => {
  ...
  const output = `${root}/gentler-contact-${c.name}-integrity.json`;
...
writeFileSync(`${root}/gentler-contact-integrity.json`, JSON.stringify({version: 1, passed: true, profiles,
