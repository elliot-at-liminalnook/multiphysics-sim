...
const root = 'examples/full-robot/whole-swing', run = 'runs/full-robot/learning/gentler-direct';
...
const profiles = plan.cases.map((c, i) => {
  ...
  const output = `${root}/gentler-direct-${c.name}-integrity.json`;
...
writeFileSync(`${root}/gentler-direct-integrity.json`, JSON.stringify({version: 1, passed: true, profiles,
