...
try{
 ...
 if(displayRate!==undefined)await page.locator('#display-rate').selectOption(displayRate);
 const displayRateHz=await page.locator('#display-rate').count()?Number(await page.locator('#display-rate').inputValue()):0;
